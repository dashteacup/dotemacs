;; Author: Paul Curry
;; Created: 2013-07-03
;; Time-stamp: <2013-07-03 19:03:07 pcurry>
...
;; ~/.elisp/site-lisp. Run the `update-autoloads-for-packages' function to
...
located in the same directory. "
  ...
  (let ((package-directory (file-truename
    ...
    ;; (generate-autoload-file) used by update-file-autoloads
